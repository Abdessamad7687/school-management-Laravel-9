            ...
            <div>
                ...
                @endif
                    <form id="contact-form" method="POST">
                        ...
                        <input type="text" id="fname" value="{{ old('nom') }}" placeholder="Nom *" name="nom">
                        @error('nom')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror

                        <input type="text" id="lname" value="{{ old('prenom') }}"  placeholder="Prénom" name="prenom">

                        <input type="text" id="email" value="{{ old('email') }}" placeholder="Votre Email *" name="email">

                        @error('email')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror

                        <input type="tel" id="phone" value="{{ old('telephone') }}" placeholder="Numéro de téléphone" name="telephone">

                        <input type="text" id="msg" style="padding: 70px;" placeholder="Votre Message"

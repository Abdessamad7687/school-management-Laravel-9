...
@section('content')
    ...
    <div class="container">
        <div class="metier text-center">
            ...
            <div class="formation-options">
                ...
                <select name="" id="">
                    <option value="Les thematiques de Formation">Les thematiques de Formation</option>
                    <option value="Presse / Communication">Presse / Communication </option>
                    <option value="Techniques d'audiovisuel">Techniques d'audiovisuel</option>
                    <option value="Formation modulaire">Formation modulaire</option>
                </select>

                <select name="" id="">
                    <option value="Mon Niveau d'Etude">Mon Niveau d'Etude</option>
                    <option value="je suis Lyceen">je suis Lyceen</option>
                    <option value="j'ai le bac">j'ai le bac</option>
                    <option value="j'ai un bac + 1">j'ai un bac + 1</option>
                    <option value="j'ai un bac + 2">j'ai un bac + 2</option>
                    <option value="j'ai un bac + 3 ou +">j'ai un bac + 3 ou +</option>
                </select>

                <select name="select" id="select">
                    <option value="Mon Projet">Mon Projet</option>
                    <option value="je cherche une formation diplomante">je cherche une formation diplomante</option>
                    <option value="je cherche une formation certifiante">je cherche une formation certifiante</option>
                    <option value="je cherche une boîte de production">je cherche une boîte de production</option>
                    <option value="je cherche un partenaire">je cherche un partenaire</option>
                </select>
                <button><a href="{{ route('Formation') }}">Ok</a></button>

                <!-- Formation options End -->
            </div>
            <h2><a href="{{ route('Formation') }}">
    ...
    <div class="photos">
        <div class="circle-cards">
            <div class="image-circle">
                ...
                <button><a href="{{ route('News') }}">News</a></button>
            </div>
            <div class="image-circle">
                <img src="./img/News1.jpg" alt="" srcset="">
                <button><a>Reportages</a></button>
            </div>
            <div class="image-circle">
                <img src="./img/Mediatique.jpg" alt="" srcset="">
                <button><a>Couvertures</a></button>
            </div>
            <div class="image-circle">
                <img src="./img/emissions.jpg" alt="" srcset="">
                <button><a>Emissions</a></button>
            </div>
            <div class="image-circle">
                <img src="./img/Magazines.jpg" alt="" srcset="">
                <button><a>Magazines</a></button>
            </div>
        </div>
        ...
        <div class="circle-cards">
            <div class="image-circle">
                ...
                <button><a>Podcasts</a></button>
            </div>
            <div class="image-circle">
                <img src="./img/circle1.jpg" alt="" srcset="">
                <button><a>Making Off</a></button>
            </div>
            <div class="image-circle">
                <img src="./img/metrage.jpg" alt="" srcset="">
                <button><a>Courts Métrages</a></button>
            </div>
            <div class="image-circle">
                <img src="./img/ecole.jpg" alt="" srcset="">
                <button><a>Autres vidéos</a></button>
            </div>
        </div>
    </div>
    ...
    <div class="footer-basic mt-5">
        ...
        <div id="mybutton">
            <button class="feedback"><a href="{{ route('inscription') }}">Inscriptions ouvertes
                    2022/2023</a></button>
        </div>
